...
HXLINE(  49)		text1->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  50)		if ((week == -1)) {
...
HXLINE(  64)		this->yesText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXLINE(  68)		this->noText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
