...
HXLINE(  84)		{
HXLINE(  84)			::String v7 = (::ManifestResources_obj::rootPath + HX_("manifest/week7.json",53,1e,57,58));
HXDLIN(  84)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week7",c3,95,be,c7),v7);
            		}
HXLINE(  85)		{
HXLINE(  85)			::String v8 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  85)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v8);
            		}
HXLINE(  88)		library = ::lime::utils::Assets_obj::getLibrary(HX_("videos",98,d7,95,e5));
HXLINE(  89)		if (::hx::IsNotNull( library )) {
HXLINE(  89)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  90)			::ManifestResources_obj::preloadLibraryNames->push(HX_("videos",98,d7,95,e5));
            		}
HXLINE(  91)		library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  92)		if (::hx::IsNotNull( library )) {
HXLINE(  92)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  93)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE(  94)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  95)		if (::hx::IsNotNull( library )) {
HXLINE(  95)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  96)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
...
HXLINE( 112)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week7",c3,95,be,c7));
HXLINE( 113)		if (::hx::IsNotNull( library )) {
HXLINE( 113)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 114)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week7",c3,95,be,c7));
            		}
HXLINE( 115)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE( 116)		if (::hx::IsNotNull( library )) {
HXLINE( 116)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 117)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
