...
HXLINE(  74)			this->panel->screenCenter(null());
HXLINE(  75)			this->panelbg->scrollFactor->set(null(),null());
HXLINE(  76)			this->panelbg->screenCenter(null());
...
HXLINE(  86)			textshit1->screenCenter(null());
HXLINE(  87)			this->buttonAccept->screenCenter(null());
HXLINE(  88)			this->buttonNo->screenCenter(null());
...
HXLINE(  90)			 ::flixel::ui::FlxButton _hx_tmp = this->buttonAccept;
HXDLIN(  90)			Float _hx_tmp1 = this->panel->y;
HXDLIN(  90)			_hx_tmp->set_y(((_hx_tmp1 + this->panel->get_height()) - ( (Float)(30) )));
...
HXLINE(  92)			 ::flixel::ui::FlxButton _hx_tmp2 = this->buttonNo;
HXDLIN(  92)			Float _hx_tmp3 = this->panel->y;
HXDLIN(  92)			_hx_tmp2->set_y(((_hx_tmp3 + this->panel->get_height()) - ( (Float)(30) )));
