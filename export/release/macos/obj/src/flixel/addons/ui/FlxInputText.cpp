...
HXDLIN( 357)			if ((key == 67)) {
HXLINE( 357)				_hx_tmp = e->commandKey;
            			}
            			else {
...
HXDLIN( 371)			if ((key == 86)) {
HXLINE( 371)				_hx_tmp1 = e->commandKey;
            			}
            			else {
...
HXDLIN( 391)			if ((key == 88)) {
HXLINE( 391)				_hx_tmp2 = e->commandKey;
            			}
            			else {
...
HXLINE( 833)					pattern = this->customFilterPattern;
            				...
            				break;
            				default:{
HXLINE( 835)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::Error_obj::__alloc( HX_CTX ,((HX_("FlxInputText: Unknown filterMode (",04,c7,17,56) + this->filterMode) + HX_(")",29,00,00,00)),null())));
            				}
            			}
